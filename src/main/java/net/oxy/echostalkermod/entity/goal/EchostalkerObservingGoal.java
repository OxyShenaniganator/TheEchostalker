package net.oxy.echostalkermod.entity.goal;
...
public class EchostalkerObservingGoal extends Goal {
    ...
    public EchostalkerObservingGoal(EchostalkerEntity mob, double trackingDistance, double trackingRefreshRate) {
